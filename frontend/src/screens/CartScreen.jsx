...
import { Row, Card, Col, ListGroup, ListGroupItem, Image, Form, Tab, Button } from 'react-bootstrap';
        ...
        <Row>
            <Col md={8}>
                ...
                {cartItems.length === 0 ? <Message>
                    Your cart is empty
                    <Link to='/'>
                        <span style={{marginLeft:'15px', textDecoration:'underline'}}>Go Back</span>
                    </Link>
                </Message> : (
            ...
            <Col md={4}>
                <Card>
                    <ListGroup variant='flush'>
                        <ListGroupItem>
                            <h2>Subtotal ({cartItems.reduce((a,c) => {
                                return a + c.qty;
                            },0)}) items
                            </h2>
                            ${cartItems
